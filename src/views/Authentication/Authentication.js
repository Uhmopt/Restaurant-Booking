...
export default function LoginPage(props) {
  ...
  function submitLogin(e) {
    var config = {
      method: 'get',
      url: `https://cors-anywhere.herokuapp.com/https://ontab.co.uk/v1/user/account-confirmation?token=${passCode}`,
      headers: { }
    };
    ...
    .catch(error => {
      toastr.error('Check you email and insert correct token!', 'Token error');
