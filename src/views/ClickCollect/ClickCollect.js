...
import RestaurantGallery from '../ClickCollect/RestaurantGallery.js';
...
import image2 from "assets/img/image4.jpg";
...
export default function Components(props) {
	...
	function initGetEstablishments () {
		setRestaurant(JSON.parse(localStorage.getItem('restaurantList')));
	}
	...
	return (
		<div style={{background: '#fff'}}>
			<Header
				brand='OnTab'
				rightLinks={<HeaderLinks style={{padding: "2px"}}/>}
				fixed
				color='dark'
				changeColorOnScroll={{
					height: 100,
			...
			<div className={classes_com.container} style={{marginTop: '70px'}}>
				<GridContainer>
					<GridItem md={3}>
					...
					<GridItem md={9}>
						...
						<RestaurantGallery style={{marginTop: "30px"}} list={restaurantList}/>
					</GridItem>
				</GridContainer>
			</div>
			<Footer/>
